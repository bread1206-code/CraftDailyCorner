...
namespace CraftDailyCorner.Services
{
    public class CreatorPostService : ICreatorPostService
    {
            ...
            string? currentMemberId)
        {
            ...
            if (!string.IsNullOrWhiteSpace(query.PostKeyword))
            {
                baseQuery = baseQuery.Where(p =>
                    p.Title.Contains(query.PostKeyword) ||
                    p.Content.Contains(query.PostKeyword));
            }
            ...
            string creatorId)
        {
            ...
            if (post.Visibility == CreatorVisibility.Public ||
                post.Visibility == CreatorVisibility.Followers)
            {
